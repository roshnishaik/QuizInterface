...
$qquery="create table posterparticipantdetails(teamname varchar(30),teamsize int,topicname varchar(30),emailid1 varchar(30),emailid2 varchar(30),primary key(emailid1),foreign key(emailid1) references participantdetails(emailid))";
...
if($flag2!=1)
{
if(mysqli_query($con,"insert into posterparticipantdetails values('$teamname','$teamsize','$topic','$emailid1','$emailid2')"))
				{
