...
if( $row['random']=='0')
{
 ...
 $ran= rand(1,311);
 $query= "UPDATE codingusers SET random='".$ran."' WHERE username='".$user."'";
 mysql_query($query);
}
else
$ran=$row['random'];
...
iframe{
 padding:0px;
-moz-box-shadow: 0 0 8px 6px sienna;
-webkit-box-shadow: 0 0 8px 6px sienna;
box-shadow: 0 0 10px 6px sienna;
...
border:5px inset #006B8F;
 box-shadow: 0px 0px 8px 4px sienna;
 -moz-box-shadow: 0 0 8px 4px sienna;
 -moz-box-shadow: 0 0 8px 4px sienna;
}
...
#stwa{
text-shadow: 0px 3px 5px sienna;
-moz-text-shadow: 0px 3px 5px sienna;
-webkit-text-shadow: 0px 3px 5px sienna;
...
cellpadding:1px;}
 ...
 <BODY  oncopy="return false;" onpaste="return false;" oncut="return false;" style="background-color:white" onload="stopwatch();" >
 <img id="ql" src="questlogo.jpg"><!--questlogo-->

<h2 style="top:2px;color:sienna;position:fixed;right:148px;font-family:Gabriola">TIME LEFT</h2>
<input type="text" id="stwa" value=""  style="width:12%; font-size:30px; text-align:center; position:fixed; top:55px; right:152px" disabled/>  
 ...
 <img style="position:fixed;left:380px;top:20px" src="image.jpg"/>
 
 <form id="ques" action="1.php" target="quespage" method="post" >
      <table border="0" cellpadding="1" cellspacing="0">
      <th colspan="6" height="40" width="40" style="font-family:Gabriola">
  ...
  <tr>
      ...
      <button class="aa" style="margin-left:95px;margin-top:625px;position:fixed" type="submit">END TEST</button>
...
<h2 style="position:fixed;left:310px;top:11%;font-family:Gabriola;color:sienna">WELCOME <?php echo $_SESSION['username'];?></h4>
...
var mins=29;  //declare global variable called mins and assign 0
