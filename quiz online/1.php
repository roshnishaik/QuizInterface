...
if( $num )
{
$sql= 'SELECT * FROM quizquestions WHERE id="'.$num.'"';
...
<form  action="2.php" method="post">
   <tr><td><input type="hidden" name="2" value="<?php echo $count; ?>"></td></tr>
  <tr><td id="que"><B><?php echo $count.')'.$row['questions']; ?></B></td></tr>
 ...
 <tr><td><hr size="3" color="white"></td></tr>
 <button style="left:30%"class="aa" name="we" type="submit" value="<?php echo $num;?>" >SUBMIT</button>
